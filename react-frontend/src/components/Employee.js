          ...
          <form>
              ...
              <div class="form-group">
                ...
                />
                 ...
                 <div>
              <button   class="btn btn-primary m-3"  onClick={save}>Register</button>
              <button   class="btn btn-warning m-3"  onClick={update}>Update</button>
              </div>   
            </form>
          </div>
<div class="m-5">
      ...
      <th scope="col">Option</th>
       ...
       {employees.map(function fn(employee)
       {
            ...
            <tbody>
                ...
                <td>
                    <button type="button" class="btn btn-warning m-3"  onClick={() => editEmployee(employee)} >Edit</button>  
                    <button type="button" class="btn btn-danger m-3" onClick={() => DeleteEmployee(employee.id)}>Delete</button>
                </td>
                </tr>
            </tbody>
            );
